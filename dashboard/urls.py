...
from .views import inicio, reporte_mensual, exportar_ventas_excel, dashboard_comparativo, analitica_avanzada
...
urlpatterns = [ 
    ...
    path('analitica/', analitica_avanzada, name='analitica_avanzada'),
    path('exportar-excel/', exportar_ventas_excel, name='exportar_ventas_excel'),
]